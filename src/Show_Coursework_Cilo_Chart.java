 ...
 */
@WebServlet("/Show_Coursework_Cilo_Chart")
public class Show_Coursework_Cilo_Chart extends HttpServlet {
     ...
     */
    public Show_Coursework_Cilo_Chart() {
        super();
    ...
    //	String data3="[{ \"category\": [{ \"label\": \"cilo1\"}, { \"label\": \"cilo2\" }, {\"label\": \"cilo3\"}] }]";
      ...
      //  RequestDispatcher rd = request.getRequestDispatcher("Course_work_Cilo_PieChart.jsp");  
        RequestDispatcher rd = request.getRequestDispatcher("Course_work_Cilo_Boxplot.jsp"); 
